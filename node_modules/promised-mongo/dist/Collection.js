...
var indexName = function indexName(index) {
  ...
  _createClass(Collection, [{
    ...
    value: function findOne(query, projection) {
      ...
      return _regeneratorRuntime.async(function findOne$(context$2$0) {
        while (1) switch (context$2$0.prev = context$2$0.next) {
          case 0:
            cursor = this.find.apply(this, args$2$0).limit(1);
            context$2$0.next = 3;
        ...
        while (1) switch (context$2$0.prev = context$2$0.next) {
          ...
          case 6:
            ...
            return _regeneratorRuntime.awrap(new _Promise(function (resolve, reject) {
              server.insert(self.fullCollectionName, docList, self.defaultWriteOptions, function (error) {
                if (error) {
                  reject(error);
                } else {
                  resolve(docs);
